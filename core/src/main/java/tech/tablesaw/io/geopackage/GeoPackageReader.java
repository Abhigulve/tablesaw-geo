package tech.tablesaw.io.geopackage;
/*
...
public class GeoPackageReader {
   ...
   */
  public static Table read(FeatureResultSet resultSet) throws SQLException {
  ...
  protected static void appendToColumn(Column<?> column, FeatureResultSet resultSet, Object value) {
